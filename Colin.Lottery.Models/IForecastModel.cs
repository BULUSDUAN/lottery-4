...
namespace Colin.Lottery.Models
{
    ...
    /// 预测数据模型接口
    /// </summary>
    public interface IForecastModel:IForecastSharedModel
    {
        /// <summary>
        /// 期号范围
        /// </summary>
    ...
    /// 预测数据集模型接口
    /// </summary>
    public interface IForecastPlanModel:IForecastSharedModel
    {
        /// <summary>
        /// 预测数据
        /// </summary>
        List<IForecastModel> ForecastData { get; set; }

        /// <summary>
        /// 最新预测开奖号码
        /// </summary>
        string ForecastDrawNo { get; }
    }

    /// <summary>
    /// 预测数据Plan级与最新期共享字段
    /// </summary>
    public interface IForecastSharedModel
    {
        /// <summary>
        /// 玩法规则
        /// </summary>
